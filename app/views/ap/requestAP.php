...
<div class="container">
    <div class="page-inner">
        <div class="row mb-3">
            <div class="col-md-12">
                <a href="<?php echo URLROOT; ?>/aps" class="btn btn-primary position-relative">AP's</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">Manage Request AP's</h4>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="#" id="viewForm" method="POST" enctype>
                                        ...
                                        <div class="modal-footer border-0">
                                            <!-- <button type="submit" id="saveApApproval" class="btn btn-primary">Save</button> -->
    ...
    function attitionReasons(myvar) {
        ...
        if (reasonDetail) {
            $.ajax({
                ...
                type: 'post',
                data: {
                    id_reasonType: attrition_reason,
                    step: 'reasonsDetail'
                },
                success: function(response) {
